...
formData.append('trainerId', trainer._id);
    axios.post(dietUploadURL,formData,{withCredentials:true}).then((response:any)=>{
    ...
    <div className='flex '>
      <Navbar />
        ...
        <div className='pl-10 pt-32 w-5/12 ' >
          <h1 className='text-5xl font-bold mb-5'>Diet Upload</h1>
          ...
          <form action="" onSubmit={handleSubmit(onSubmit)} >
            ...
            <label > Title </label> <br /> 
                <input  type="text"  {...register("title", { required: true })}  className='mb-5 bg-transparent outline outline-1 outline-gray-500 text-sm rounded p-2 w-72' placeholder='Enter diet title'  /> 
              ...
              <label > type</label>  <br />
                ...
                <input  type="text "  {...register("type", { required: true })}  className='mb-5 bg-transparent outline outline-1 outline-gray-500 text-sm rounded p-2 w-72' placeholder='Enter food type'  /> <br />
                {errors.type && <p className='font-extralight  text-sm h-2 text-red-700'>This field is required</p>}
              </div>
