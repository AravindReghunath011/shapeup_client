...
const VideoUpload = () => {
    ...
    const onSubmit = async (data) => {
        ...
        axios.post(videoUpload, formData, { withCredentials: true }).then((response) => {
